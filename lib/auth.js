...
// Non-redirecting check — use this when a page needs to render
// differently depending on login state instead of forcing a redirect
// (e.g. the landing page's "Tạo link cho bài này" buttons).
