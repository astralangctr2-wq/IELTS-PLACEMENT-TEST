...
export function normalizeContent(raw) {
  ...
  return {
    ...
    reading: { sections: normalizeReadingSections(raw.reading) },
    listening: { sections: normalizeListeningSections(raw.listening) },
...
export function withIds(content) {
  return {
    ...
    reading: { sections: idReadingSections(toSections(content.reading, "passage")) },
    listening: { sections: idListeningSections(toSections(content.listening, "script")) },
...
export function withoutAnswers(content) {
  ...
  return {
    ...
    reading: { sections: stripReading(content.reading.sections) },
    listening: { sections: stripListening(content.listening.sections) },
    writing: { prompt: content.writing.prompt },
  };
}
